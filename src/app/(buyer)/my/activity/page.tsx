    ...
    <div className="mx-auto max-w-6xl animate-in fade-in slide-in-from-bottom-4 space-y-8 pb-12 duration-500">
      ...
      <div className="flex flex-wrap gap-6">
        <div className="flex items-center gap-2.5 rounded-[12px] border border-border bg-card px-5 py-3.5">
          ...
          <span className="text-[15px] font-bold text-foreground">{formatPrice(stats.totalSpent)}</span>
        </div>
        <div className="flex items-center gap-2.5 rounded-[12px] border border-border bg-card px-5 py-3.5">
          <ShoppingBag className="h-4 w-4 text-primary" />
          <span className="text-[13px] text-muted-foreground">Ideas unlocked</span>
          <span className="text-[15px] font-bold text-foreground">{stats.totalPurchases}</span>
        </div>
      </div>
