...
export default function CheckoutCancelPage() {
  return (
    <div className="container mx-auto px-6 py-24 flex items-center justify-center min-h-[70vh] animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="w-full max-w-[440px] rounded-[12px] border border-border bg-card p-8 md:p-10 text-center shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
        
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-destructive/10 border border-destructive/20 shadow-sm mb-6">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <Button asChild className="w-full font-medium h-11 transition-all">
            <Link href="/ideas">Continue Browsing</Link>
          </Button>
          <Button asChild variant="outline" className="w-full h-11 transition-colors">
            <Link href="/">
