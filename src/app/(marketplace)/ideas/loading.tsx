    ...
    <div className="bg-[#F5F6FA] min-h-screen py-12 md:py-16">
      <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div className="mb-8 pb-6 border-b border-[#D9DCE3]">
          <Skeleton className="h-10 w-64 md:w-96 bg-[#D9DCE3]/50 rounded-[8px]" />
          <Skeleton className="mt-4 h-5 w-48 md:w-72 bg-[#D9DCE3]/50 rounded-[6px]" />
        </div>

        {/* Filters Skeleton */}
        <div className="mb-10">
          <Skeleton className="h-12 w-full max-w-2xl bg-[#D9DCE3]/50 rounded-[10px]" />
        </div>

        {/* Cards Grid Skeleton */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="h-[380px] rounded-[12px] bg-[#FFFFFF] border border-[#D9DCE3] shadow-[0_4px_14px_rgba(0,0,0,0.02)] p-5 flex flex-col">
