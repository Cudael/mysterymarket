...
export async function sendWelcomeEmail(to: string, name: string) {
  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #ffffff; padding: 40px 24px;">
      <h1 style="font-size: 28px; font-weight: bold; margin-bottom: 8px;">Welcome to IdeaVex! 💡</h1>
      <p style="color: #a1a1aa; margin-bottom: 24px;">Hi ${displayName}, we're excited to have you on board.</p>
      <p style="margin-bottom: 16px;">IdeaVex is a premium marketplace where creators share their best ideas — hidden behind a paywall. Buyers unlock them one at a time.</p>
